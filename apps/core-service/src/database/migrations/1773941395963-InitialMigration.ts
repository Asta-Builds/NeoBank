...
export class InitialMigration1773941395963 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."users_role_enum" AS ENUM('CUSTOMER', 'SUPPORT', 'COMPLIANCE_OFFICER', 'ADMIN')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."wallets_status_enum" AS ENUM('PENDING', 'ACTIVE', 'FROZEN', 'SUSPENDED', 'CLOSED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_type_enum" AS ENUM('TOP_UP', 'P2P_TRANSFER', 'CARD_PAYMENT', 'REVERSAL', 'FEE')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."transactions_status_enum" AS ENUM('INITIATED', 'PENDING', 'PROCESSING', 'SUCCEEDED', 'FAILED', 'REVERSED', 'CANCELLED')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "FK_234520b8d2b63e97a7875b66abf" FOREIGN KEY ("senderWalletId") REFERENCES "wallets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" ADD CONSTRAINT "FK_ffdc7a29d1be1b4e3aff2919df0" FOREIGN KEY ("receiverWalletId") REFERENCES "wallets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "kyc_cases" ADD CONSTRAINT "FK_a67c29bf36be9e32be8faf7336f" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "kyc_cases" ADD CONSTRAINT "FK_bc6a66480eea641c58d14359d7a" FOREIGN KEY ("reviewedBy") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "kyc_cases" DROP CONSTRAINT "FK_bc6a66480eea641c58d14359d7a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "kyc_cases" DROP CONSTRAINT "FK_a67c29bf36be9e32be8faf7336f"`,
    );
    await queryRunner.query(
      `ALTER TABLE "ledger_entries" DROP CONSTRAINT "FK_df977c08d98fab6543724d74859"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "FK_ffdc7a29d1be1b4e3aff2919df0"`,
    );
    await queryRunner.query(
      `ALTER TABLE "transactions" DROP CONSTRAINT "FK_234520b8d2b63e97a7875b66abf"`,
    );
    await queryRunner.query(
