...
export class IdenfyProvider implements IKycProvider {
  ...
  constructor(private readonly configService: ConfigService) {
    this.apiKey =
      this.configService.get<string>('IDENFY_API_KEY') || 'mock-key';
    this.apiSecret =
      this.configService.get<string>('IDENFY_API_SECRET') || 'mock-secret';
    this.apiUrl =
      this.configService.get<string>('IDENFY_API_URL') ||
      'https://api.idenfy.com/api/v2';
  }
